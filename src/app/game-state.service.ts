...
export class GameStateService {
  ...
  public getGameState(gameId:string):Observable<GameState> {
    return this.httpClient.post<GameState>("https://xserver:8167/state/getGameState", {gameId:gameId});
  }

  public getUnitStates(gameId:string):Observable<UnitState[]> {
    return this.httpClient.post<UnitState[]>("https://xserver:8167/state/getUnitStates", {gameId:gameId});
  }

  public getTerrainStates(gameId:string):Observable<TerrainState[]> {
    return this.httpClient.post<TerrainState[]>("https://xserver:8167/state/getTerrainStates", {gameId:gameId});
  }

  public getPlayerStates(gameId:string):Observable<PlayerState[]> {
    return this.httpClient.post<PlayerState[]>("https://xserver:8167/state/getPlayerStates", {gameId:gameId});
  }

  public getSettingState(gameId:string):Observable<SettingsState> {
    return this.httpClient.post<SettingsState>("https://xserver:8167/state/getSettingState", {gameId:gameId});
  }
}
