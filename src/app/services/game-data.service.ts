...
export class GameDataService {
  ...
  public getMovementRules(modId:string):Observable<MovementRule[]> {
    return this.httpClient.get<MovementRule[]>("data/getMovementRules", {headers:{modId:modId}});
  }
  ...
  ): Observable<ModMetadata[]> {
    let headers = new HttpHeaders;
    let value: keyof typeof options;
